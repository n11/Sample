function mainVm() {
	var self = this;
	this.myData = ko.observableArray([{ name: "あいう円", age: 50 },
                                      { name: "Tiancum", age: 43 },
                                      { name: "Jacob", age: 27 },
                                      { name: "Nephi", age: 29 },
                                      { name: "Nephi", age: 29 },
